...
CREATE TABLE `orszagok` (
  `id` int(11) NOT NULL COMMENT 'azonosító',
  `orszag` varchar(27) NOT NULL DEFAULT '' COMMENT 'az ország neve',
  `fovaros` varchar(19) NOT NULL DEFAULT '' COMMENT 'az ország fővárosa',
  `foldr_hely` varchar(37) NOT NULL DEFAULT '' COMMENT 'földrajzi elhelyezkedés',
  `terulet` decimal(11,2) NOT NULL DEFAULT 0.00 COMMENT 'terület km2-ben',
  `allamforma` varchar(30) NOT NULL DEFAULT '' COMMENT 'államforma',
  `nepesseg` int(8) NOT NULL DEFAULT 0 COMMENT 'népesség 1000 főben van megadva!',
  `nep_fovaros` int(8) NOT NULL DEFAULT 0 COMMENT 'a főváros népessége 1000 főben van megadva!',
  `autojel` char(3) NOT NULL DEFAULT '' COMMENT 'autójel',
  `country` varchar(31) NOT NULL DEFAULT '' COMMENT 'országnév ékezetes írás nélkül, idegen elnevezésekkel is',
  `capital` varchar(19) NOT NULL DEFAULT '' COMMENT 'főváros ékezetes írás nélkül, idegen elnevezésekkel is',
  `penznem` varchar(20) NOT NULL DEFAULT '' COMMENT 'pénznem',
  `penzjel` char(3) NOT NULL DEFAULT '' COMMENT 'pénzjel',
  `valtopenz` varchar(18) NOT NULL DEFAULT '' COMMENT 'váltópénz a váltószámmal együtt',
  `telefon` int(3) NOT NULL DEFAULT 0 COMMENT 'nemzetközi telefon-hívószám',
  `gdp` int(5) NOT NULL DEFAULT 0 COMMENT 'egy főre jutó bruttó hazai termék USA dollárban (GDP: gross domestic product)',
  `kat` int(1) NOT NULL DEFAULT 0 COMMENT 'ismertségi kategória (1,2,3)'
